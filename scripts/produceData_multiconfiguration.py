...
def run_cmsDriver(configdata, release):
    ...
    command = f"echo $PWD; module use /opt/exp_soft/vo.llr.in2p3.fr/modulefiles_el7/; module purge; module load python/3.9.9; \
        ...
        for key, value in conf.items():
            ...
            if key==release:
              ...
              if os.path.exists(f"hgcal_tpg_validation_{confName}_{release}_USER.py"):
                ...
                sourceProc = subprocess.Popen(sourceCmd, stdout=logfile, stderr=logfile,  shell=True)
