...
def run_cmsDriver(configdata, label, release_path):
    ...
    command = ("echo $PWD; set -v; echo $$ $BASHPID ; ( echo $$ $BASHPID  ); " + "cd " + release_path + "; printenv; shopt -s expand_aliases; set +u && source /cvmfs/cms.cern.ch/cmsset_default.sh; set -u; " +
